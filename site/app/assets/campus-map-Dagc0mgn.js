...
`)}const q0={[Ul]:"Linear",[Dl]:"Reinhard",[Nl]:"Cineon",[Fl]:"ACESFilmic",[zl]:"AgX",[Hl]:"Neutral",[Bl]:"Custom"};function Z0(i,t){const e=q0[t];return e===void 0?(Bt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const zs=new I;function K0(){te.getLuminanceCoefficients(zs);const i=zs.x.toFixed(4),t=zs.y.toFixed(4),e=zs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
}`,Im=[new I(1,0,0),new I(-1,0,0),new I(0,1,0),new I(0,-1,0),new I(0,0,1),new I(0,0,-1)],Pm=[new I(0,-1,0),new I(0,-1,0),new I(0,0,1),new I(0,0,-1),new I(0,-1,0),new I(0,-1,0)],Ml=new xe,ki=new I,Hr=new I;function Om(i,t,e){let n=new tc;const s=new Mt,r=new Mt,o=new Me,a=new Gd,l=new kd,c={},u=e.maxTextureSize,p={[si]:Qe,[Qe]:si,[Je]:Je},d=new bn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Mt},radius:{value:4}},vertexShader:wm,fragmentShader:Rm}),h=d.clone();h.defines.HORIZONTAL_PASS=1;const g=new Te;g.setAttribute("position",new $e(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new Ye(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ks;let f=this.type;this.render=function(y,R,v){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||y.length===0)return;this.type===Lc&&(Bt("WebGLShadowMap: PCFSoftShadowMap has been removed. Using PCFShadowMap instead."),this.type=ks);const C=i.getRenderTarget(),D=i.getActiveCubeFace(),F=i.getActiveMipmapLevel(),z=i.state;z.setBlending(Un),z.buffers.depth.getReversed()===!0?z.buffers.color.setClear(0,0,0,0):z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const W=f!==this.type;W&&R.traverse(function(N){N.material&&(Array.isArray(N.material)?N.material.forEach(k=>k.needsUpdate=!0):N.material.needsUpdate=!0)});for(let N=0,k=y.length;N<k;N++){const q=y[N],K=q.shadow;if(K===void 0){Bt("WebGLShadowMap:",q,"has no shadow.");continue}if(K.autoUpdate===!1&&K.needsUpdate===!1)continue;s.copy(K.mapSize);const at=K.getFrameExtents();s.multiply(at),r.copy(K.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/at.x),s.x=r.x*at.x,K.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/at.y),s.y=r.y*at.y,K.mapSize.y=r.y));const $=i.state.buffers.depth.getReversed();if(K.camera._reversedDepth=$,K.map===null||W===!0){if(K.map!==null&&(K.map.depthTexture!==null&&(K.map.depthTexture.dispose(),K.map.depthTexture=null),K.map.dispose()),this.type===Vi){if(q.isPointLight){Bt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}K.map=new fn(s.x,s.y,{format:oi,type:yn,minFilter:Ge,magFilter:Ge,generateMipmaps:!1}),K.map.texture.name=q.name+".shadowMap",K.map.depthTexture=new ns(s.x,s.y,xn),K.map.depthTexture.name=q.name+".shadowMapDepth",K.map.depthTexture.format=Nn,K.map.depthTexture.compareFunction=null,K.map.depthTexture.minFilter=Ne,K.map.depthTexture.magFilter=Ne}else q.isPointLight?(K.map=new xc(s.x),K.map.depthTexture=new id(s.x,Mn)):(K.map=new fn(s.x,s.y),K.map.depthTexture=new ns(s.x,s.y,Mn)),K.map.depthTexture.name=q.name+".shadowMap",K.map.depthTexture.format=Nn,this.type===ks?(K.map.depthTexture.compareFunction=$?Wo:Vo,K.map.depthTexture.minFilter=Ge,K.map.depthTexture.magFilter=Ge):(K.map.depthTexture.compareFunction=null,K.map.depthTexture.minFilter=Ne,K.map.depthTexture.magFilter=Ne);K.camera.updateProjectionMatrix()}K.map.isWebGLCubeRenderTarget!==!0&&(K.map.width!==s.x||K.map.height!==s.y)&&K.map.setSize(s.x,s.y);const it=K.map.isWebGLCubeRenderTarget?6:K.getViewportCount();q.isPointLight!==!0&&K.updateMatrices(q,v);for(let ot=0;ot<it;ot++){const Ct=K.getCamera(ot);if(q.isPointLight){const Ot=K.camera,oe=K.matrix,Ft=q.distance||Ot.far;Ft!==Ot.far&&(Ot.far=Ft,Ot.updateProjectionMatrix()),ki.setFromMatrixPosition(q.matrixWorld),Ot.position.copy(ki),Hr.copy(Ot.position),Hr.add(Im[ot]),Ot.up.copy(Pm[ot]),Ot.lookAt(Hr),Ot.updateMatrixWorld(),oe.makeTranslation(-ki.x,-ki.y,-ki.z),Ml.multiplyMatrices(Ot.projectionMatrix,Ot.matrixWorldInverse),K._frustum.setFromProjectionMatrix(Ml,Ot.coordinateSystem,Ot.reversedDepth)}if(K.map.isWebGLCubeRenderTarget)i.setRenderTarget(K.map,ot),i.clear();else{ot===0&&(i.setRenderTarget(K.map),i.clear());const Ot=K.getViewport(ot);o.set(r.x*Ot.x,r.y*Ot.y,r.x*Ot.z,r.y*Ot.w),z.viewport(o)}n=K.getFrustum(ot),S(R,v,Ct,q,this.type)}K.isPointLightShadow!==!0&&this.type===Vi&&T(K,v),K.needsUpdate=!1}f=this.type,m.needsUpdate=!1,i.setRenderTarget(C,D,F)};function T(y,R){const v=t.update(M);d.defines.VSM_SAMPLES!==y.blurSamples&&(d.defines.VSM_SAMPLES=y.blurSamples,h.defines.VSM_SAMPLES=y.blurSamples,d.needsUpdate=!0,h.needsUpdate=!0),y.mapPass===null?y.mapPass=new fn(s.x,s.y,{format:oi,type:yn}):(y.mapPass.width!==y.map.width||y.mapPass.height!==y.map.height)&&y.mapPass.setSize(y.map.width,y.map.height),d.uniforms.shadow_pass.value=y.map.depthTexture,d.uniforms.resolution.value.set(y.map.width,y.map.height),d.uniforms.radius.value=y.radius,i.setRenderTarget(y.mapPass),i.clear(),i.renderBufferDirect(R,null,v,d,M,null),h.uniforms.shadow_pass.value=y.mapPass.texture,h.uniforms.resolution.value.set(y.map.width,y.map.height),h.uniforms.radius.value=y.radius,i.setRenderTarget(y.map),i.clear(),i.renderBufferDirect(R,null,v,h,M,null)}function w(y,R,v,C){let D=null;const F=v.isPointLight===!0?y.customDistanceMaterial:y.customDepthMaterial;if(F!==void 0)D=F;else if(D=v.isPointLight===!0?l:a,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const z=D.uuid,W=R.uuid;let N=c[z];N===void 0&&(N={},c[z]=N);let k=N[W];k===void 0&&(k=D.clone(),N[W]=k,R.addEventListener("dispose",E)),D=k}if(D.visible=R.visible,D.wireframe=R.wireframe,C===Vi?D.side=R.shadowSide!==null?R.shadowSide:R.side:D.side=R.shadowSide!==null?R.shadowSide:p[R.side],D.alphaMap=R.alphaMap,D.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,D.map=R.map,D.clipShadows=R.clipShadows,D.clippingPlanes=R.clippingPlanes,D.clipIntersection=R.clipIntersection,D.displacementMap=R.displacementMap,D.displacementScale=R.displacementScale,D.displacementBias=R.displacementBias,D.wireframeLinewidth=R.wireframeLinewidth,D.linewidth=R.linewidth,v.isPointLight===!0&&D.isMeshDistanceMaterial===!0){const z=i.properties.get(D);z.light=v}return D}function S(y,R,v,C,D){if(y.visible===!1)return;if(y.layers.test(R.layers)&&(y.isMesh||y.isLine||y.isPoints)&&(y.castShadow||y.receiveShadow&&D===Vi)&&(!y.frustumCulled||y.intersectsFrustum(n))){y.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,y.matrixWorld);const W=t.update(y),N=y.material;if(Array.isArray(N)){const k=W.groups;for(let q=0,K=k.length;q<K;q++){const at=k[q],$=N[at.materialIndex];if($&&$.visible){const it=w(y,$,C,D);y.onBeforeShadow(i,y,R,v,W,it,at),i.renderBufferDirect(v,null,W,it,y,at),y.onAfterShadow(i,y,R,v,W,it,at)}}}else if(N.visible){const k=w(y,N,C,D);y.onBeforeShadow(i,y,R,v,W,k,null),i.renderBufferDirect(v,null,W,k,y,null),y.onAfterShadow(i,y,R,v,W,k,null)}}const z=y.children;for(let W=0,N=z.length;W<N;W++)S(z[W],R,v,C,D)}function E(y){y.target.removeEventListener("dispose",E);for(const v in c){const C=c[v],D=y.target.uuid;D in C&&(C[D].dispose(),delete C[D])}}}function Lm(i,t){function e(){let L=!1;const ht=new Me;let tt=null;const pt=new Me(0,0,0,0);return{setMask:function(A){tt!==A&&!L&&(i.colorMask(A,A,A,A),tt=A)},setLocked:function(A){L=A},setClear:function(A,P,Z,X,st){st===!0&&(A*=X,P*=X,Z*=X),ht.set(A,P,Z,X),pt.equals(ht)===!1&&(i.clearColor(A,P,Z,X),pt.copy(ht))},reset:function(){L=!1,tt=null,pt.set(-1,0,0,0)}}}function n(){let L=!1,ht=!1,tt=null,pt=null,A=null;return{setReversed:function(P){if(ht!==P){const Z=t.get("EXT_clip_control");P?Z.clipControlEXT(Z.LOWER_LEFT_EXT,Z.ZERO_TO_ONE_EXT):Z.clipControlEXT(Z.LOWER_LEFT_EXT,Z.NEGATIVE_ONE_TO_ONE_EXT),ht=P;const X=A;A=null,this.setClear(X)}},getReversed:function(){return ht},setTest:function(P){P?et(i.DEPTH_TEST):yt(i.DEPTH_TEST)},setMask:function(P){tt!==P&&!L&&(i.depthMask(P),tt=P)},setFunc:function(P){if(ht&&(P=pu[P]),pt!==P){switch(P){case Wr:i.depthFunc(i.NEVER);break;case Xr:i.depthFunc(i.ALWAYS);break;case Yr:i.depthFunc(i.LESS);break;case Qi:i.depthFunc(i.LEQUAL);break;case qr:i.depthFunc(i.EQUAL);break;case Zr:i.depthFunc(i.GEQUAL);break;case Kr:i.depthFunc(i.GREATER);break;case Jr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}pt=P}},setLocked:function(P){L=P},setClear:function(P){A!==P&&(A=P,ht&&(P=1-P),i.clearDepth(P))},reset:function(){L=!1,tt=null,pt=null,A=null,ht=!1}}}function s(){let L=!1,ht=null,tt=null,pt=null,A=null,P=null,Z=null,X=null,st=null;return{setTest:function(rt){L||(rt?et(i.STENCIL_TEST):yt(i.STENCIL_TEST))},setMask:function(rt){ht!==rt&&!L&&(i.stencilMask(rt),ht=rt)},setFunc:function(rt,bt,ut){(tt!==rt||pt!==bt||A!==ut)&&(i.stencilFunc(rt,bt,ut),tt=rt,pt=bt,A=ut)},setOp:function(rt,bt,ut){(P!==rt||Z!==bt||X!==ut)&&(i.stencilOp(rt,bt,ut),P=rt,Z=bt,X=ut)},setLocked:function(rt){L=rt},setClear:function(rt){st!==rt&&(i.clearStencil(rt),st=rt)},reset:function(){L=!1,ht=null,tt=null,pt=null,A=null,P=null,Z=null,X=null,st=null}}}const r=new e,o=new n,a=new s,l=new WeakMap,c=new WeakMap;let u={},p={},d={},h=new WeakMap,g=[],M=null,m=!1,f=null,T=null,w=null,S=null,E=null,y=null,R=null,v=new Jt(0,0,0),C=0,D=!1,F=null,z=null,W=null,N=null,k=null;const q=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let K=!1,at=0;const $=i.getParameter(i.VERSION);$.indexOf("WebGL")!==-1?(at=parseFloat(/^WebGL (\d)/.exec($)[1]),K=at>=1):$.indexOf("OpenGL ES")!==-1&&(at=parseFloat(/^OpenGL ES (\d)/.exec($)[1]),K=at>=2);let it=null,ot={};const Ct=i.getParameter(i.SCISSOR_BOX),Ot=i.getParameter(i.VIEWPORT),oe=new Me().fromArray(Ct),Ft=new Me().fromArray(Ot);function ee(L,ht,tt,pt){const A=new Uint8Array(4),P=i.createTexture();i.bindTexture(L,P),i.texParameteri(L,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(L,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Z=0;Z<tt;Z++)L===i.TEXTURE_3D||L===i.TEXTURE_2D_ARRAY?i.texImage3D(ht,0,i.RGBA,1,1,pt,0,i.RGBA,i.UNSIGNED_BYTE,A):i.texImage2D(ht+Z,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,A);return P}const Q={};Q[i.TEXTURE_2D]=ee(i.TEXTURE_2D,i.TEXTURE_2D,1),Q[i.TEXTURE_CUBE_MAP]=ee(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Q[i.TEXTURE_2D_ARRAY]=ee(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Q[i.TEXTURE_3D]=ee(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),et(i.DEPTH_TEST),o.setFunc(Qi),$t(!1),se(la),et(i.CULL_FACE),Xt(Un);function et(L){u[L]!==!0&&(i.enable(L),u[L]=!0)}function yt(L){u[L]!==!1&&(i.disable(L),u[L]=!1)}function Nt(L,ht){return d[L]!==ht?(i.bindFramebuffer(L,ht),d[L]=ht,L===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=ht),L===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=ht),!0):!1}function St(L,ht){let tt=g,pt=!1;if(L){tt=h.get(ht),tt===void 0&&(tt=[],h.set(ht,tt));const A=L.textures;if(tt.length!==A.length||tt[0]!==i.COLOR_ATTACHMENT0){for(let P=0,Z=A.length;P<Z;P++)tt[P]=i.COLOR_ATTACHMENT0+P;tt.length=A.length,pt=!0}}else tt[0]!==i.BACK&&(tt[0]=i.BACK,pt=!0);pt&&i.drawBuffers(tt)}function Vt(L){return M!==L?(i.useProgram(L),M=L,!0):!1}const _e={[Ti]:i.FUNC_ADD,[Dc]:i.FUNC_SUBTRACT,[Nc]:i.FUNC_REVERSE_SUBTRACT};_e[Fc]=i.MIN,_e[Bc]=i.MAX;const Wt={[zc]:i.ZERO,[Hc]:i.ONE,[Gc]:i.SRC_COLOR,[Pl]:i.SRC_ALPHA,[qc]:i.SRC_ALPHA_SATURATE,[Xc]:i.DST_COLOR,[Vc]:i.DST_ALPHA,[kc]:i.ONE_MINUS_SRC_COLOR,[Ol]:i.ONE_MINUS_SRC_ALPHA,[Yc]:i.ONE_MINUS_DST_COLOR,[Wc]:i.ONE_MINUS_DST_ALPHA,[Zc]:i.CONSTANT_COLOR,[Kc]:i.ONE_MINUS_CONSTANT_COLOR,[Jc]:i.CONSTANT_ALPHA,[$c]:i.ONE_MINUS_CONSTANT_ALPHA};function Xt(L,ht,tt,pt,A,P,Z,X,st,rt){if(L===Un){m===!0&&(yt(i.BLEND),m=!1);return}if(m===!1&&(et(i.BLEND),m=!0),L!==Uc){if(L!==f||rt!==D){if((T!==Ti||E!==Ti)&&(i.blendEquation(i.FUNC_ADD),T=Ti,E=Ti),rt)switch(L){case Yi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ca:i.blendFunc(i.ONE,i.ONE);break;case ua:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case da:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:ie("WebGLState: Invalid blending: ",L);break}else switch(L){case Yi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ca:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case ua:ie("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case da:ie("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:ie("WebGLState: Invalid blending: ",L);break}w=null,S=null,y=null,R=null,v.set(0,0,0),C=0,f=L,D=rt}return}A=A||ht,P=P||tt,Z=Z||pt,(ht!==T||A!==E)&&(i.blendEquationSeparate(_e[ht],_e[A]),T=ht,E=A),(tt!==w||pt!==S||P!==y||Z!==R)&&(i.blendFuncSeparate(Wt[tt],Wt[pt],Wt[P],Wt[Z]),w=tt,S=pt,y=P,R=Z),(X.equals(v)===!1||st!==C)&&(i.blendColor(X.r,X.g,X.b,st),v.copy(X),C=st),f=L,D=!1}function Yt(L,ht){L.side===Je?yt(i.CULL_FACE):et(i.CULL_FACE);let tt=L.side===Qe;ht&&(tt=!tt),$t(tt),L.blending===Yi&&L.transparent===!1?Xt(Un):Xt(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),o.setFunc(L.depthFunc),o.setTest(L.depthTest),o.setMask(L.depthWrite),r.setMask(L.colorWrite);const pt=L.stencilWrite;a.setTest(pt),pt&&(a.setMask(L.stencilWriteMask),a.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),a.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),Ce(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?et(i.SAMPLE_ALPHA_TO_COVERAGE):yt(i.SAMPLE_ALPHA_TO_COVERAGE)}function $t(L){F!==L&&(L?i.frontFace(i.CW):i.frontFace(i.CCW),F=L)}function se(L){L!==Pc?(et(i.CULL_FACE),L!==z&&(L===la?i.cullFace(i.BACK):L===Oc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):yt(i.CULL_FACE),z=L}function Se(L){L!==W&&(K&&i.lineWidth(L),W=L)}function Ce(L,ht,tt){L?(et(i.POLYGON_OFFSET_FILL),(N!==ht||k!==tt)&&(N=ht,k=tt,o.getReversed()&&(ht=-ht),i.polygonOffset(ht,tt))):yt(i.POLYGON_OFFSET_FILL)}function de(L){L?et(i.SCISSOR_TEST):yt(i.SCISSOR_TEST)}function pe(L){L===void 0&&(L=i.TEXTURE0+q-1),it!==L&&(i.activeTexture(L),it=L)}function U(L,ht,tt){tt===void 0&&(it===null?tt=i.TEXTURE0+q-1:tt=it);let pt=ot[tt];pt===void 0&&(pt={type:void 0,texture:void 0},ot[tt]=pt),(pt.type!==L||pt.texture!==ht)&&(it!==tt&&(i.activeTexture(tt),it=tt),i.bindTexture(L,ht||Q[L]),pt.type=L,pt.texture=ht)}function Pe(){const L=ot[it];L!==void 0&&L.type!==void 0&&(i.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function jt(){try{i.compressedTexImage2D(...arguments)}catch(L){ie("WebGLState:",L)}}function b(){try{i.compressedTexImage3D(...arguments)}catch(L){ie("WebGLState:",L)}}function _(){try{i.texSubImage2D(...arguments)}catch(L){ie("WebGLState:",L)}}function B(){try{i.texSubImage3D(...arguments)}catch(L){ie("WebGLState:",L)}}function V(){try{i.compressedTexSubImage2D(...arguments)}catch(L){ie("WebGLState:",L)}}function J(){try{i.compressedTexSubImage3D(...arguments)}catch(L){ie("WebGLState:",L)}}function lt(){try{i.texStorage2D(...arguments)}catch(L){ie("WebGLState:",L)}}function dt(){try{i.texStorage3D(...arguments)}catch(L){ie("WebGLState:",L)}}function j(){try{i.texImage2D(...arguments)}catch(L){ie("WebGLState:",L)}}function nt(){try{i.texImage3D(...arguments)}catch(L){ie("WebGLState:",L)}}function ft(L){return p[L]!==void 0?p[L]:i.getParameter(L)}function Lt(L,ht){p[L]!==ht&&(i.pixelStorei(L,ht),p[L]=ht)}function gt(L){oe.equals(L)===!1&&(i.scissor(L.x,L.y,L.z,L.w),oe.copy(L))}function mt(L){Ft.equals(L)===!1&&(i.viewport(L.x,L.y,L.z,L.w),Ft.copy(L))}function Rt(L,ht){let tt=c.get(ht);tt===void 0&&(tt=new WeakMap,c.set(ht,tt));let pt=tt.get(L);pt===void 0&&(pt=i.getUniformBlockIndex(ht,L.name),tt.set(L,pt))}function Dt(L,ht){const pt=c.get(ht).get(L);l.get(ht)!==pt&&(i.uniformBlockBinding(ht,pt,L.__bindingPointIndex),l.set(ht,pt))}function Ht(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),u={},p={},it=null,ot={},d={},h=new WeakMap,g=[],M=null,m=!1,f=null,T=null,w=null,S=null,E=null,y=null,R=null,v=new Jt(0,0,0),C=0,D=!1,F=null,z=null,W=null,N=null,k=null,oe.set(0,0,i.canvas.width,i.canvas.height),Ft.set(0,0,i.canvas.width,i.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:et,disable:yt,bindFramebuffer:Nt,drawBuffers:St,useProgram:Vt,setBlending:Xt,setMaterial:Yt,setFlipSided:$t,setCullFace:se,setLineWidth:Se,setPolygonOffset:Ce,setScissorTest:de,activeTexture:pe,bindTexture:U,unbindTexture:Pe,compressedTexImage2D:jt,compressedTexImage3D:b,texImage2D:j,texImage3D:nt,pixelStorei:Lt,getParameter:ft,updateUBOMapping:Rt,uniformBlockBinding:Dt,texStorage2D:lt,texStorage3D:dt,texSubImage2D:_,texSubImage3D:B,compressedTexSubImage2D:V,compressedTexSubImage3D:J,scissor:gt,viewport:mt,reset:Ht}}function Um(i,t,e,n,s,r,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Mt,u=new WeakMap,p=new Set;let d;const h=new WeakMap;let g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(b,_){return g?new OffscreenCanvas(b,_):tr("canvas")}function m(b,_,B){let V=1;const J=jt(b);if((J.width>B||J.height>B)&&(V=B/Math.max(J.width,J.height)),V<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){const lt=Math.floor(V*J.width),dt=Math.floor(V*J.height);d===void 0&&(d=M(lt,dt));const j=_?M(lt,dt):d;return j.width=lt,j.height=dt,j.getContext("2d").drawImage(b,0,0,lt,dt),Bt("WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+lt+"x"+dt+")."),j}else return"data"in b&&Bt("WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),b;return b}function f(b){return b.generateMipmaps}function T(b){i.generateMipmap(b)}function w(b){return b.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:b.isWebGL3DRenderTarget?i.TEXTURE_3D:b.isWebGLArrayRenderTarget||b.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function S(b,_,B,V,J,lt=!1){if(b!==null){if(i[b]!==void 0)return i[b];Bt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let dt;V&&(dt=t.get("EXT_texture_norm16"),dt||Bt("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let j=_;if(_===i.RED&&(B===i.FLOAT&&(j=i.R32F),B===i.HALF_FLOAT&&(j=i.R16F),B===i.UNSIGNED_BYTE&&(j=i.R8),B===i.UNSIGNED_SHORT&&dt&&(j=dt.R16_EXT),B===i.SHORT&&dt&&(j=dt.R16_SNORM_EXT)),_===i.RED_INTEGER&&(B===i.UNSIGNED_BYTE&&(j=i.R8UI),B===i.UNSIGNED_SHORT&&(j=i.R16UI),B===i.UNSIGNED_INT&&(j=i.R32UI),B===i.BYTE&&(j=i.R8I),B===i.SHORT&&(j=i.R16I),B===i.INT&&(j=i.R32I)),_===i.RG&&(B===i.FLOAT&&(j=i.RG32F),B===i.HALF_FLOAT&&(j=i.RG16F),B===i.UNSIGNED_BYTE&&(j=i.RG8),B===i.UNSIGNED_SHORT&&dt&&(j=dt.RG16_EXT),B===i.SHORT&&dt&&(j=dt.RG16_SNORM_EXT)),_===i.RG_INTEGER&&(B===i.UNSIGNED_BYTE&&(j=i.RG8UI),B===i.UNSIGNED_SHORT&&(j=i.RG16UI),B===i.UNSIGNED_INT&&(j=i.RG32UI),B===i.BYTE&&(j=i.RG8I),B===i.SHORT&&(j=i.RG16I),B===i.INT&&(j=i.RG32I)),_===i.RGB_INTEGER&&(B===i.UNSIGNED_BYTE&&(j=i.RGB8UI),B===i.UNSIGNED_SHORT&&(j=i.RGB16UI),B===i.UNSIGNED_INT&&(j=i.RGB32UI),B===i.BYTE&&(j=i.RGB8I),B===i.SHORT&&(j=i.RGB16I),B===i.INT&&(j=i.RGB32I)),_===i.RGBA_INTEGER&&(B===i.UNSIGNED_BYTE&&(j=i.RGBA8UI),B===i.UNSIGNED_SHORT&&(j=i.RGBA16UI),B===i.UNSIGNED_INT&&(j=i.RGBA32UI),B===i.BYTE&&(j=i.RGBA8I),B===i.SHORT&&(j=i.RGBA16I),B===i.INT&&(j=i.RGBA32I)),_===i.RGB&&(B===i.UNSIGNED_SHORT&&dt&&(j=dt.RGB16_EXT),B===i.SHORT&&dt&&(j=dt.RGB16_SNORM_EXT),B===i.UNSIGNED_INT_5_9_9_9_REV&&(j=i.RGB9_E5),B===i.UNSIGNED_INT_10F_11F_11F_REV&&(j=i.R11F_G11F_B10F)),_===i.RGBA){const nt=lt?Qs:te.getTransfer(J);B===i.FLOAT&&(j=i.RGBA32F),B===i.HALF_FLOAT&&(j=i.RGBA16F),B===i.UNSIGNED_BYTE&&(j=nt===le?i.SRGB8_ALPHA8:i.RGBA8),B===i.UNSIGNED_SHORT&&dt&&(j=dt.RGBA16_EXT),B===i.SHORT&&dt&&(j=dt.RGBA16_SNORM_EXT),B===i.UNSIGNED_SHORT_4_4_4_4&&(j=i.RGBA4),B===i.UNSIGNED_SHORT_5_5_5_1&&(j=i.RGB5_A1)}return(j===i.R16F||j===i.R32F||j===i.RG16F||j===i.RG32F||j===i.RGBA16F||j===i.RGBA32F)&&t.get("EXT_color_buffer_float"),j}function E(b,_){let B;return b?_===null||_===Mn||_===ts?B=i.DEPTH24_STENCIL8:_===xn?B=i.DEPTH32F_STENCIL8:_===ji&&(B=i.DEPTH24_STENCIL8,Bt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Mn||_===ts?B=i.DEPTH_COMPONENT24:_===xn?B=i.DEPTH_COMPONENT32F:_===ji&&(B=i.DEPTH_COMPONENT16),B}function y(b,_){return f(b)===!0||b.isFramebufferTexture&&b.minFilter!==Ne&&b.minFilter!==Ge?Math.log2(Math.max(_.width,_.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?_.mipmaps.length:1}function R(b){const _=b.target;_.removeEventListener("dispose",R),C(_),_.isVideoTexture&&u.delete(_),_.isHTMLTexture&&p.delete(_)}function v(b){const _=b.target;_.removeEventListener("dispose",v),F(_)}function C(b){const _=n.get(b);if(_.__webglInit===void 0)return;const B=b.source,V=h.get(B);if(V){const J=V[_.__cacheKey];J.usedTimes--,J.usedTimes===0&&D(b),Object.keys(V).length===0&&h.delete(B)}n.remove(b)}function D(b){const _=n.get(b);i.deleteTexture(_.__webglTexture);const B=b.source,V=h.get(B);delete V[_.__cacheKey],o.memory.textures--}function F(b){const _=n.get(b);if(b.depthTexture&&(b.depthTexture.dispose(),n.remove(b.depthTexture)),b.isWebGLCubeRenderTarget)for(let V=0;V<6;V++){if(Array.isArray(_.__webglFramebuffer[V]))for(let J=0;J<_.__webglFramebuffer[V].length;J++)i.deleteFramebuffer(_.__webglFramebuffer[V][J]);else i.deleteFramebuffer(_.__webglFramebuffer[V]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[V])}else{if(Array.isArray(_.__webglFramebuffer))for(let V=0;V<_.__webglFramebuffer.length;V++)i.deleteFramebuffer(_.__webglFramebuffer[V]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let V=0;V<_.__webglColorRenderbuffer.length;V++)_.__webglColorRenderbuffer[V]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[V]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const B=b.textures;for(let V=0,J=B.length;V<J;V++){const lt=n.get(B[V]);lt.__webglTexture&&(i.deleteTexture(lt.__webglTexture),o.memory.textures--),n.remove(B[V])}n.remove(b)}let z=0;function W(){z=0}function N(){return z}function k(b){z=b}function q(){const b=z;return b>=s.maxTextures&&Bt("WebGLTextures: Trying to use "+(b+1)+" texture units while this GPU supports only "+s.maxTextures),z+=1,b}function K(b){const _=[];return _.push(b.wrapS),_.push(b.wrapT),_.push(b.wrapR||0),_.push(b.magFilter),_.push(b.minFilter),_.push(b.anisotropy),_.push(b.internalFormat),_.push(b.format),_.push(b.type),_.push(b.generateMipmaps),_.push(b.premultiplyAlpha),_.push(b.flipY),_.push(b.unpackAlignment),_.push(b.colorSpace),_.join()}function at(b,_){const B=n.get(b);if(b.isVideoTexture&&U(b),b.isRenderTargetTexture===!1&&b.isExternalTexture!==!0&&b.version>0&&B.__version!==b.version){const V=b.image;if(V===null)Bt("WebGLRenderer: Texture marked for update but no image data found.");else if(V.complete===!1)Bt("WebGLRenderer: Texture marked for update but image is incomplete");else{yt(B,b,_);return}}else b.isExternalTexture&&(B.__webglTexture=b.sourceTexture?b.sourceTexture:null);e.bindTexture(i.TEXTURE_2D,B.__webglTexture,i.TEXTURE0+_)}function $(b,_){const B=n.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&B.__version!==b.version){yt(B,b,_);return}else b.isExternalTexture&&(B.__webglTexture=b.sourceTexture?b.sourceTexture:null);e.bindTexture(i.TEXTURE_2D_ARRAY,B.__webglTexture,i.TEXTURE0+_)}function it(b,_){const B=n.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&B.__version!==b.version){yt(B,b,_);return}e.bindTexture(i.TEXTURE_3D,B.__webglTexture,i.TEXTURE0+_)}function ot(b,_){const B=n.get(b);if(b.isCubeDepthTexture!==!0&&b.version>0&&B.__version!==b.version){Nt(B,b,_);return}e.bindTexture(i.TEXTURE_CUBE_MAP,B.__webglTexture,i.TEXTURE0+_)}const Ct={[$r]:i.REPEAT,[Pn]:i.CLAMP_TO_EDGE,[Qr]:i.MIRRORED_REPEAT},Ot={[Ne]:i.NEAREST,[tu]:i.NEAREST_MIPMAP_NEAREST,[ds]:i.NEAREST_MIPMAP_LINEAR,[Ge]:i.LINEAR,[cr]:i.LINEAR_MIPMAP_NEAREST,[ni]:i.LINEAR_MIPMAP_LINEAR},oe={[su]:i.NEVER,[cu]:i.ALWAYS,[ru]:i.LESS,[Vo]:i.LEQUAL,[ou]:i.EQUAL,[Wo]:i.GEQUAL,[au]:i.GREATER,[lu]:i.NOTEQUAL};function Ft(b,_){if(_.type===xn&&t.has("OES_texture_float_linear")===!1&&(_.magFilter===Ge||_.magFilter===cr||_.magFilter===ds||_.magFilter===ni||_.minFilter===Ge||_.minFilter===cr||_.minFilter===ds||_.minFilter===ni)&&Bt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(b,i.TEXTURE_WRAP_S,Ct[_.wrapS]),i.texParameteri(b,i.TEXTURE_WRAP_T,Ct[_.wrapT]),(b===i.TEXTURE_3D||b===i.TEXTURE_2D_ARRAY)&&i.texParameteri(b,i.TEXTURE_WRAP_R,Ct[_.wrapR]),i.texParameteri(b,i.TEXTURE_MAG_FILTER,Ot[_.magFilter]),i.texParameteri(b,i.TEXTURE_MIN_FILTER,Ot[_.minFilter]),_.compareFunction&&(i.texParameteri(b,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(b,i.TEXTURE_COMPARE_FUNC,oe[_.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Ne||_.minFilter!==ds&&_.minFilter!==ni||_.type===xn&&t.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const B=t.get("EXT_texture_filter_anisotropic");i.texParameterf(b,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function ee(b,_){let B=!1;b.__webglInit===void 0&&(b.__webglInit=!0,_.addEventListener("dispose",R));const V=_.source;let J=h.get(V);J===void 0&&(J={},h.set(V,J));const lt=K(_);if(lt!==b.__cacheKey){J[lt]===void 0&&(J[lt]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,B=!0),J[lt].usedTimes++;const dt=J[b.__cacheKey];dt!==void 0&&(J[b.__cacheKey].usedTimes--,dt.usedTimes===0&&D(_)),b.__cacheKey=lt,b.__webglTexture=J[lt].texture}return B}function Q(b,_,B){return Math.floor(Math.floor(b/B)/_)}function et(b,_,B,V){const lt=b.updateRanges;if(lt.length===0)e.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,B,V,_.data);else{lt.sort((Lt,gt)=>Lt.start-gt.start);let dt=0;for(let Lt=1;Lt<lt.length;Lt++){const gt=lt[dt],mt=lt[Lt],Rt=gt.start+gt.count,Dt=Q(mt.start,_.width,4),Ht=Q(gt.start,_.width,4);mt.start<=Rt+1&&Dt===Ht&&Q(mt.start+mt.count-1,_.width,4)===Dt?gt.count=Math.max(gt.count,mt.start+mt.count-gt.start):(++dt,lt[dt]=mt)}lt.length=dt+1;const j=e.getParameter(i.UNPACK_ROW_LENGTH),nt=e.getParameter(i.UNPACK_SKIP_PIXELS),ft=e.getParameter(i.UNPACK_SKIP_ROWS);e.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let Lt=0,gt=lt.length;Lt<gt;Lt++){const mt=lt[Lt],Rt=Math.floor(mt.start/4),Dt=Math.ceil(mt.count/4),Ht=Rt%_.width,L=Math.floor(Rt/_.width),ht=Dt,tt=1;e.pixelStorei(i.UNPACK_SKIP_PIXELS,Ht),e.pixelStorei(i.UNPACK_SKIP_ROWS,L),e.texSubImage2D(i.TEXTURE_2D,0,Ht,L,ht,tt,B,V,_.data)}b.clearUpdateRanges(),e.pixelStorei(i.UNPACK_ROW_LENGTH,j),e.pixelStorei(i.UNPACK_SKIP_PIXELS,nt),e.pixelStorei(i.UNPACK_SKIP_ROWS,ft)}}function yt(b,_,B){let V=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(V=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(V=i.TEXTURE_3D);const J=ee(b,_),lt=_.source;e.bindTexture(V,b.__webglTexture,i.TEXTURE0+B);const dt=n.get(lt);if(lt.version!==dt.__version||J===!0){if(e.activeTexture(i.TEXTURE0+B),(typeof ImageBitmap<"u"&&_.image instanceof ImageBitmap)===!1){const tt=te.getPrimaries(te.workingColorSpace),pt=_.colorSpace===Yn?null:te.getPrimaries(_.colorSpace),A=_.colorSpace===Yn||tt===pt?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,A)}e.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment);let nt=m(_.image,!1,s.maxTextureSize);nt=Pe(_,nt);const ft=r.convert(_.format,_.colorSpace),Lt=r.convert(_.type);let gt=S(_.internalFormat,ft,Lt,_.normalized,_.colorSpace,_.isVideoTexture);Ft(V,_);let mt;const Rt=_.mipmaps,Dt=_.isVideoTexture!==!0,Ht=dt.__version===void 0||J===!0,L=lt.dataReady,ht=y(_,nt);if(_.isDepthTexture)gt=E(_.format===ii,_.type),Ht&&(Dt?e.texStorage2D(i.TEXTURE_2D,1,gt,nt.width,nt.height):e.texImage2D(i.TEXTURE_2D,0,gt,nt.width,nt.height,0,ft,Lt,null));else if(_.isDataTexture)if(Rt.length>0){Dt&&Ht&&e.texStorage2D(i.TEXTURE_2D,ht,gt,Rt[0].width,Rt[0].height);for(let tt=0,pt=Rt.length;tt<pt;tt++)mt=Rt[tt],Dt?L&&e.texSubImage2D(i.TEXTURE_2D,tt,0,0,mt.width,mt.height,ft,Lt,mt.data):e.texImage2D(i.TEXTURE_2D,tt,gt,mt.width,mt.height,0,ft,Lt,mt.data);_.generateMipmaps=!1}else Dt?(Ht&&e.texStorage2D(i.TEXTURE_2D,ht,gt,nt.width,nt.height),L&&et(_,nt,ft,Lt)):e.texImage2D(i.TEXTURE_2D,0,gt,nt.width,nt.height,0,ft,Lt,nt.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Dt&&Ht&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ht,gt,Rt[0].width,Rt[0].height,nt.depth);for(let tt=0,pt=Rt.length;tt<pt;tt++)if(mt=Rt[tt],_.format!==dn)if(ft!==null)if(Dt){if(L)if(_.layerUpdates.size>0){const A=ja(mt.width,mt.height,_.format,_.type);for(const P of _.layerUpdates){const Z=mt.data.subarray(P*A/mt.data.BYTES_PER_ELEMENT,(P+1)*A/mt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,tt,0,0,P,mt.width,mt.height,1,ft,Z)}}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,tt,0,0,0,mt.width,mt.height,nt.depth,ft,mt.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,tt,gt,mt.width,mt.height,nt.depth,0,mt.data,0,0);else Bt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Dt?L&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,tt,0,0,0,mt.width,mt.height,nt.depth,ft,Lt,mt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,tt,gt,mt.width,mt.height,nt.depth,0,ft,Lt,mt.data);_.layerUpdates.size>0&&_.clearLayerUpdates()}else{Dt&&Ht&&e.texStorage2D(i.TEXTURE_2D,ht,gt,Rt[0].width,Rt[0].height);for(let tt=0,pt=Rt.length;tt<pt;tt++)mt=Rt[tt],_.format!==dn?ft!==null?Dt?L&&e.compressedTexSubImage2D(i.TEXTURE_2D,tt,0,0,mt.width,mt.height,ft,mt.data):e.compressedTexImage2D(i.TEXTURE_2D,tt,gt,mt.width,mt.height,0,mt.data):Bt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Dt?L&&e.texSubImage2D(i.TEXTURE_2D,tt,0,0,mt.width,mt.height,ft,Lt,mt.data):e.texImage2D(i.TEXTURE_2D,tt,gt,mt.width,mt.height,0,ft,Lt,mt.data)}else if(_.isDataArrayTexture)if(Dt){if(Ht&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ht,gt,nt.width,nt.height,nt.depth),L)if(_.layerUpdates.size>0){const tt=ja(nt.width,nt.height,_.format,_.type);for(const pt of _.layerUpdates){const A=nt.data.subarray(pt*tt/nt.data.BYTES_PER_ELEMENT,(pt+1)*tt/nt.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,pt,nt.width,nt.height,1,ft,Lt,A)}_.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,nt.width,nt.height,nt.depth,ft,Lt,nt.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,gt,nt.width,nt.height,nt.depth,0,ft,Lt,nt.data);else if(_.isData3DTexture)Dt?(Ht&&e.texStorage3D(i.TEXTURE_3D,ht,gt,nt.width,nt.height,nt.depth),L&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,nt.width,nt.height,nt.depth,ft,Lt,nt.data)):e.texImage3D(i.TEXTURE_3D,0,gt,nt.width,nt.height,nt.depth,0,ft,Lt,nt.data);else if(_.isFramebufferTexture){if(Ht)if(Dt)e.texStorage2D(i.TEXTURE_2D,ht,gt,nt.width,nt.height);else{let tt=nt.width,pt=nt.height;for(let A=0;A<ht;A++)e.texImage2D(i.TEXTURE_2D,A,gt,tt,pt,0,ft,Lt,null),tt>>=1,pt>>=1}}else if(_.isHTMLTexture){if("texElementImage2D"in i){const tt=i.canvas;if(tt.hasAttribute("layoutsubtree")||tt.setAttribute("layoutsubtree","true"),nt.parentNode!==tt){tt.appendChild(nt),p.add(_),tt.onpaint=pt=>{const A=pt.changedElements;for(const P of p)A.includes(P.image)&&(P.needsUpdate=!0)},tt.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,nt);else{const A=i.RGBA,P=i.RGBA,Z=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,A,P,Z,nt)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Rt.length>0){if(Dt&&Ht){const tt=jt(Rt[0]);e.texStorage2D(i.TEXTURE_2D,ht,gt,tt.width,tt.height)}for(let tt=0,pt=Rt.length;tt<pt;tt++)mt=Rt[tt],Dt?L&&e.texSubImage2D(i.TEXTURE_2D,tt,0,0,ft,Lt,mt):e.texImage2D(i.TEXTURE_2D,tt,gt,ft,Lt,mt);_.generateMipmaps=!1}else if(Dt){if(Ht){const tt=jt(nt);e.texStorage2D(i.TEXTURE_2D,ht,gt,tt.width,tt.height)}L&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,ft,Lt,nt)}else e.texImage2D(i.TEXTURE_2D,0,gt,ft,Lt,nt);f(_)&&T(V),dt.__version=lt.version,_.onUpdate&&_.onUpdate(_)}b.__version=_.version}function Nt(b,_,B){if(_.image.length!==6)return;const V=ee(b,_),J=_.source;e.bindTexture(i.TEXTURE_CUBE_MAP,b.__webglTexture,i.TEXTURE0+B);const lt=n.get(J);if(J.version!==lt.__version||V===!0){e.activeTexture(i.TEXTURE0+B);const dt=te.getPrimaries(te.workingColorSpace),j=_.colorSpace===Yn?null:te.getPrimaries(_.colorSpace),nt=_.colorSpace===Yn||dt===j?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),e.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,nt);const ft=_.isCompressedTexture||_.image[0].isCompressedTexture,Lt=_.image[0]&&_.image[0].isDataTexture,gt=[];for(let P=0;P<6;P++)!ft&&!Lt?gt[P]=m(_.image[P],!0,s.maxCubemapSize):gt[P]=Lt?_.image[P].image:_.image[P],gt[P]=Pe(_,gt[P]);const mt=gt[0],Rt=r.convert(_.format,_.colorSpace),Dt=r.convert(_.type),Ht=S(_.internalFormat,Rt,Dt,_.normalized,_.colorSpace),L=_.isVideoTexture!==!0,ht=lt.__version===void 0||V===!0,tt=J.dataReady;let pt=y(_,mt);Ft(i.TEXTURE_CUBE_MAP,_);let A;if(ft){L&&ht&&e.texStorage2D(i.TEXTURE_CUBE_MAP,pt,Ht,mt.width,mt.height);for(let P=0;P<6;P++){A=gt[P].mipmaps;for(let Z=0;Z<A.length;Z++){const X=A[Z];_.format!==dn?Rt!==null?L?tt&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+P,Z,0,0,X.width,X.height,Rt,X.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+P,Z,Ht,X.width,X.height,0,X.data):Bt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?tt&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+P,Z,0,0,X.width,X.height,Rt,Dt,X.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+P,Z,Ht,X.width,X.height,0,Rt,Dt,X.data)}}}else{if(A=_.mipmaps,L&&ht){A.length>0&&pt++;const P=jt(gt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,pt,Ht,P.width,P.height)}for(let P=0;P<6;P++)if(Lt){L?tt&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+P,0,0,0,gt[P].width,gt[P].height,Rt,Dt,gt[P].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+P,0,Ht,gt[P].width,gt[P].height,0,Rt,Dt,gt[P].data);for(let Z=0;Z<A.length;Z++){const st=A[Z].image[P].image;L?tt&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+P,Z+1,0,0,st.width,st.height,Rt,Dt,st.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+P,Z+1,Ht,st.width,st.height,0,Rt,Dt,st.data)}}else{L?tt&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+P,0,0,0,Rt,Dt,gt[P]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+P,0,Ht,Rt,Dt,gt[P]);for(let Z=0;Z<A.length;Z++){const X=A[Z];L?tt&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+P,Z+1,0,0,Rt,Dt,X.image[P]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+P,Z+1,Ht,Rt,Dt,X.image[P])}}}f(_)&&T(i.TEXTURE_CUBE_MAP),lt.__version=J.version,_.onUpdate&&_.onUpdate(_)}b.__version=_.version}function St(b,_,B,V,J,lt){const dt=r.convert(B.format,B.colorSpace),j=r.convert(B.type),nt=S(B.internalFormat,dt,j,B.normalized,B.colorSpace),ft=n.get(_),Lt=n.get(B);if(Lt.__renderTarget=_,!ft.__hasExternalTextures){const gt=Math.max(1,_.width>>lt),mt=Math.max(1,_.height>>lt);J===i.TEXTURE_3D||J===i.TEXTURE_2D_ARRAY?e.texImage3D(J,lt,nt,gt,mt,_.depth,0,dt,j,null):e.texImage2D(J,lt,nt,gt,mt,0,dt,j,null)}e.bindFramebuffer(i.FRAMEBUFFER,b),pe(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,V,J,Lt.__webglTexture,0,de(_)):(J===i.TEXTURE_2D||J>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,V,J,Lt.__webglTexture,lt),e.bindFramebuffer(i.FRAMEBUFFER,null)}function Vt(b,_,B){if(i.bindRenderbuffer(i.RENDERBUFFER,b),_.depthBuffer){const V=_.depthTexture,J=V&&V.isDepthTexture?V.type:null,lt=E(_.stencilBuffer,J),dt=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;pe(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,de(_),lt,_.width,_.height):B?i.renderbufferStorageMultisample(i.RENDERBUFFER,de(_),lt,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,lt,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,dt,i.RENDERBUFFER,b)}else{const V=_.textures;for(let J=0;J<V.length;J++){const lt=V[J],dt=r.convert(lt.format,lt.colorSpace),j=r.convert(lt.type),nt=S(lt.internalFormat,dt,j,lt.normalized,lt.colorSpace);pe(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,de(_),nt,_.width,_.height):B?i.renderbufferStorageMultisample(i.RENDERBUFFER,de(_),nt,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,nt,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function _e(b,_,B){const V=_.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(i.FRAMEBUFFER,b),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const J=n.get(_.depthTexture);if(J.__renderTarget=_,(!J.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),V){if(J.__webglInit===void 0&&(J.__webglInit=!0,_.depthTexture.addEventListener("dispose",R)),J.__webglTexture===void 0){J.__webglTexture=i.createTexture(),e.bindTexture(i.TEXTURE_CUBE_MAP,J.__webglTexture),Ft(i.TEXTURE_CUBE_MAP,_.depthTexture);const ft=r.convert(_.depthTexture.format),Lt=r.convert(_.depthTexture.type);let gt;_.depthTexture.format===Nn?gt=i.DEPTH_COMPONENT24:_.depthTexture.format===ii&&(gt=i.DEPTH24_STENCIL8);for(let mt=0;mt<6;mt++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+mt,0,gt,_.width,_.height,0,ft,Lt,null)}}else at(_.depthTexture,0);const lt=J.__webglTexture,dt=de(_),j=V?i.TEXTURE_CUBE_MAP_POSITIVE_X+B:i.TEXTURE_2D,nt=_.depthTexture.format===ii?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===Nn)pe(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,nt,j,lt,0,dt):i.framebufferTexture2D(i.FRAMEBUFFER,nt,j,lt,0);else if(_.depthTexture.format===ii)pe(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,nt,j,lt,0,dt):i.framebufferTexture2D(i.FRAMEBUFFER,nt,j,lt,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Wt(b){const _=n.get(b),B=b.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==b.depthTexture){const V=b.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),V){const J=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,V.removeEventListener("dispose",J)};V.addEventListener("dispose",J),_.__depthDisposeCallback=J}_.__boundDepthTexture=V}if(b.depthTexture&&!_.__autoAllocateDepthBuffer)if(B)for(let V=0;V<6;V++)_e(_.__webglFramebuffer[V],b,V);else{const V=b.texture.mipmaps;V&&V.length>0?_e(_.__webglFramebuffer[0],b,0):_e(_.__webglFramebuffer,b,0)}else if(B){_.__webglDepthbuffer=[];for(let V=0;V<6;V++)if(e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[V]),_.__webglDepthbuffer[V]===void 0)_.__webglDepthbuffer[V]=i.createRenderbuffer(),Vt(_.__webglDepthbuffer[V],b,!1);else{const J=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,lt=_.__webglDepthbuffer[V];i.bindRenderbuffer(i.RENDERBUFFER,lt),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,lt)}}else{const V=b.texture.mipmaps;if(V&&V.length>0?e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),Vt(_.__webglDepthbuffer,b,!1);else{const J=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,lt=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,lt),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,lt)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function Xt(b,_,B){const V=n.get(b);_!==void 0&&St(V.__webglFramebuffer,b,b.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),B!==void 0&&Wt(b)}function Yt(b){const _=b.texture,B=n.get(b),V=n.get(_);b.addEventListener("dispose",v);const J=b.textures,lt=b.isWebGLCubeRenderTarget===!0,dt=J.length>1;if(dt||(V.__webglTexture===void 0&&(V.__webglTexture=i.createTexture()),V.__version=_.version,o.memory.textures++),lt){B.__webglFramebuffer=[];for(let j=0;j<6;j++)if(_.mipmaps&&_.mipmaps.length>0){B.__webglFramebuffer[j]=[];for(let nt=0;nt<_.mipmaps.length;nt++)B.__webglFramebuffer[j][nt]=i.createFramebuffer()}else B.__webglFramebuffer[j]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){B.__webglFramebuffer=[];for(let j=0;j<_.mipmaps.length;j++)B.__webglFramebuffer[j]=i.createFramebuffer()}else B.__webglFramebuffer=i.createFramebuffer();if(dt)for(let j=0,nt=J.length;j<nt;j++){const ft=n.get(J[j]);ft.__webglTexture===void 0&&(ft.__webglTexture=i.createTexture(),o.memory.textures++)}if(b.samples>0&&pe(b)===!1){B.__webglMultisampledFramebuffer=i.createFramebuffer(),B.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let j=0;j<J.length;j++){const nt=J[j];B.__webglColorRenderbuffer[j]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,B.__webglColorRenderbuffer[j]);const ft=r.convert(nt.format,nt.colorSpace),Lt=r.convert(nt.type),gt=S(nt.internalFormat,ft,Lt,nt.normalized,nt.colorSpace,b.isXRRenderTarget===!0),mt=de(b);i.renderbufferStorageMultisample(i.RENDERBUFFER,mt,gt,b.width,b.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+j,i.RENDERBUFFER,B.__webglColorRenderbuffer[j])}i.bindRenderbuffer(i.RENDERBUFFER,null),b.depthBuffer&&(B.__webglDepthRenderbuffer=i.createRenderbuffer(),Vt(B.__webglDepthRenderbuffer,b,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(lt){e.bindTexture(i.TEXTURE_CUBE_MAP,V.__webglTexture),Ft(i.TEXTURE_CUBE_MAP,_);for(let j=0;j<6;j++)if(_.mipmaps&&_.mipmaps.length>0)for(let nt=0;nt<_.mipmaps.length;nt++)St(B.__webglFramebuffer[j][nt],b,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+j,nt);else St(B.__webglFramebuffer[j],b,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0);f(_)&&T(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(dt){for(let j=0,nt=J.length;j<nt;j++){const ft=J[j],Lt=n.get(ft);let gt=i.TEXTURE_2D;(b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(gt=b.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(gt,Lt.__webglTexture),Ft(gt,ft),St(B.__webglFramebuffer,b,ft,i.COLOR_ATTACHMENT0+j,gt,0),f(ft)&&T(gt)}e.unbindTexture()}else{let j=i.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(j=b.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(j,V.__webglTexture),Ft(j,_),_.mipmaps&&_.mipmaps.length>0)for(let nt=0;nt<_.mipmaps.length;nt++)St(B.__webglFramebuffer[nt],b,_,i.COLOR_ATTACHMENT0,j,nt);else St(B.__webglFramebuffer,b,_,i.COLOR_ATTACHMENT0,j,0);f(_)&&T(j),e.unbindTexture()}b.depthBuffer&&Wt(b)}function $t(b){const _=b.textures;for(let B=0,V=_.length;B<V;B++){const J=_[B];if(f(J)){const lt=w(b),dt=n.get(J).__webglTexture;e.bindTexture(lt,dt),T(lt),e.unbindTexture()}}}const se=[],Se=[];function Ce(b){if(b.samples>0){if(pe(b)===!1){const _=b.textures,B=b.width,V=b.height;let J=i.COLOR_BUFFER_BIT;const lt=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,dt=n.get(b),j=_.length>1;if(j)for(let ft=0;ft<_.length;ft++)e.bindFramebuffer(i.FRAMEBUFFER,dt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ft,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,dt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ft,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,dt.__webglMultisampledFramebuffer);const nt=b.texture.mipmaps;nt&&nt.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,dt.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,dt.__webglFramebuffer);for(let ft=0;ft<_.length;ft++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(J|=i.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(J|=i.STENCIL_BUFFER_BIT)),j){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,dt.__webglColorRenderbuffer[ft]);const Lt=n.get(_[ft]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Lt,0)}i.blitFramebuffer(0,0,B,V,0,0,B,V,J,i.NEAREST),l===!0&&(se.length=0,Se.length=0,se.push(i.COLOR_ATTACHMENT0+ft),b.depthBuffer&&b.storeMultisampledDepthBuffer===!1&&(se.push(lt),Se.push(lt),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Se)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,se))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),j)for(let ft=0;ft<_.length;ft++){e.bindFramebuffer(i.FRAMEBUFFER,dt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ft,i.RENDERBUFFER,dt.__webglColorRenderbuffer[ft]);const Lt=n.get(_[ft]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,dt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ft,i.TEXTURE_2D,Lt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,dt.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.storeMultisampledDepthBuffer===!1&&l){const _=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function de(b){return Math.min(s.maxSamples,b.samples)}function pe(b){const _=n.get(b);return b.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function U(b){const _=o.render.frame;u.get(b)!==_&&(u.set(b,_),b.update())}function Pe(b,_){const B=b.colorSpace,V=b.format,J=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||B!==$s&&B!==Yn&&(te.getTransfer(B)===le?(V!==dn||J!==rn)&&Bt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):ie("WebGLTextures: Unsupported texture color space:",B)),_}function jt(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(c.width=b.naturalWidth||b.width,c.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(c.width=b.displayWidth,c.height=b.displayHeight):(c.width=b.width,c.height=b.height),c}this.allocateTextureUnit=q,this.resetTextureUnits=W,this.getTextureUnits=N,this.setTextureUnits=k,this.setTexture2D=at,this.setTexture2DArray=$,this.setTexture3D=it,this.setTextureCube=ot,this.rebindTextures=Xt,this.setupRenderTarget=Yt,this.updateRenderTargetMipmap=$t,this.updateMultisampleRenderTarget=Ce,this.setupDepthRenderbuffer=Wt,this.setupFrameBufferTexture=St,this.useMultisampledRTT=pe,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function Dm(i,t){function e(n,s=Yn){let r;const o=te.getTransfer(s);if(n===rn)return i.UNSIGNED_BYTE;if(n===Bo)return i.UNSIGNED_SHORT_4_4_4_4;if(n===zo)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Wl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Xl)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===kl)return i.BYTE;if(n===Vl)return i.SHORT;if(n===ji)return i.UNSIGNED_SHORT;if(n===Fo)return i.INT;if(n===Mn)return i.UNSIGNED_INT;if(n===xn)return i.FLOAT;if(n===yn)return i.HALF_FLOAT;if(n===Yl)return i.ALPHA;if(n===ql)return i.RGB;if(n===dn)return i.RGBA;if(n===Nn)return i.DEPTH_COMPONENT;if(n===ii)return i.DEPTH_STENCIL;if(n===Zl)return i.RED;if(n===Ho)return i.RED_INTEGER;if(n===oi)return i.RG;if(n===Go)return i.RG_INTEGER;if(n===ko)return i.RGBA_INTEGER;if(n===Vs||n===Ws||n===Xs||n===Ys)if(o===le)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Vs)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Ws)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Xs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ys)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Vs)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Ws)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Xs)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ys)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===jr||n===to||n===eo||n===no)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===jr)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===to)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===eo)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===no)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===io||n===so||n===ro||n===oo||n===ao||n===Ks||n===lo)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===io||n===so)return o===le?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===ro)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===oo)return r.COMPRESSED_R11_EAC;if(n===ao)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Ks)return r.COMPRESSED_RG11_EAC;if(n===lo)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===co||n===uo||n===fo||n===ho||n===po||n===mo||n===go||n===_o||n===xo||n===vo||n===So||n===Mo||n===yo||n===bo)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===co)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===uo)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===fo)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ho)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===po)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===mo)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===go)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===_o)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===xo)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===vo)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===So)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Mo)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===yo)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===bo)return o===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Eo||n===To||n===Co)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===Eo)return o===le?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===To)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Co)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Ao||n===wo||n===Js||n===Ro)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===Ao)return r.COMPRESSED_RED_RGTC1_EXT;if(n===wo)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Js)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Ro)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===ts?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}const Nm=`
void main() {
